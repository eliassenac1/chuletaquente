...
if ($_POST) {
    ...
    if (mysqli_insert_id($conexao)) {
        header('location: reserva_confirmada_lista.php');
    } else {
        header('location: reserva_confirmada_lista.php');
    }
}
...
<head>
    ...
    <title><?php echo SYS_NAME; ?> - Reserva (Cancelar)</title>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-offset-3 col-sm-6 col-md-offset-2 col-md-8">
                <h2 class="breadcrumb tex-danger">
                    <a href="reserva_confirmada_lista.php">
                ...
                <div class="thumbnail">
                    ...
                    <div class="alert alert-warning" role="alert">
                        <form action="cancela_reserva.php" method="post" id="form_cancela_reserva" name="form_cancela_reserva" enctype="multipart/form-data">
                            <!-- id_reserva -->
                            ...
                            <label for="status_reserva">Deseja Cancelar?</label>
                            <div class="input-group">
